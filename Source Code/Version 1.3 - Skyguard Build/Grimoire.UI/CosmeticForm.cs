    ...
    public partial class CosmeticForm : DarkForm
    {
                ...
                try
                {
                    ...
                    for (int num = 0; array.Length > num; num++)
                        if (array[num].ToString().StartsWith(lbl))
                        {
                            ...
                            else if (lbl == "Ground" && txtGround1.Text != (txtGround1.Text.NullIfEmpty() ?? i[0]))
                            {
                                txtGround1.Text = i[0];
                                txtGround2.Text = i[1];
                            }
        ...
        private void btnSet_Click(object sender, EventArgs e)
        {
            ...
            switch (txt)
            {
                ...
                case "Ground":
                    txt = "mi";
                    file = txtGround1.Text;
                    link = txtGround2.Text;
                    break;
        ...
        private void btnLoadSet_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    txtGround1.Text = s[22].Split(':')[1];
                    txtGround2.Text = s[23].Split(':')[1];
                }
                catch { }
            }
        }
